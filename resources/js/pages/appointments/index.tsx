...
export default function AppointmentsIndex({ appointments = [], from, to }: { appointments?: Appointment[]; from?: string; to?: string }) {
        ...
        >
            ...
            <div className="min-h-full space-y-6 bg-[#F8FAFC] p-6 text-slate-800 dark:bg-background dark:text-foreground">
                ...
                <div className="flex items-start justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-semibold text-slate-900 dark:text-foreground">Appointments</h1>
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:gap-4">
                    <div className="flex flex-col gap-2">
                        <label htmlFor="appointment-from-date" className="text-sm font-medium text-slate-700 dark:text-foreground">
                            From
                        </label>
                    ...
                    <div className="flex flex-col gap-2">
                        <label htmlFor="appointment-to-date" className="text-sm font-medium text-slate-700 dark:text-foreground">
                            To
                        </label>
                        ...
                        {rows.length > 0 ? (
                            rows.map((appointment) => (
                                ...
                                >
                                    ...
                                    <div className="col-span-3">{appointment.patient_name}</div>

                                    <div className="col-span-2">{appointment.doctor_name}</div>
                                    ...
                                    <div className="col-span-2">{appointment.appointment_type}</div>

                                    <div className="col-span-1">{appointment.appointment_datetime}</div>
