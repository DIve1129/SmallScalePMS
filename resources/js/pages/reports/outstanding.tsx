    ...
    >
      ...
      <div className="min-h-full space-y-6 bg-[#F8FAFC] p-6 text-slate-800 dark:bg-background dark:text-foreground">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500 dark:text-muted-foreground">
              View unpaid and partially paid services within a selected
        ...
        <div className="rounded-xl border border-blue-100 bg-white p-5 shadow-sm dark:border-border dark:bg-card">
          <h2 className="mb-4 text-sm font-medium uppercase tracking-wider text-slate-500 dark:text-muted-foreground">
            Report Filters
          </h2>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-xl border border-blue-100 bg-white p-5 shadow-sm dark:border-border dark:bg-card">
            ...
            <p className="mt-2 text-2xl font-semibold text-amber-500 dark:text-amber-400">
          ...
          <div className="rounded-xl border border-blue-100 bg-white p-5 shadow-sm dark:border-border dark:bg-card">
            ...
            <p className="mt-2 text-2xl font-semibold text-[#2563EB] dark:text-foreground">
        ...
        <div className="overflow-hidden rounded-xl border border-blue-100 bg-white shadow-sm dark:border-border dark:bg-card">
          <div className="border-b border-blue-100 p-5 dark:border-border">
            ...
            <p className="mt-1 text-sm text-slate-500 dark:text-muted-foreground">
              Each unpaid or partially paid service is displayed as a separate
              row.
            </p>
          </div>
                ...
                {rows.length > 0 ? (
                  rows.map((row) => (
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap px-5 py-4 text-right font-semibold text-amber-500 dark:text-amber-400">
                  ...
                  <tr>
                    ...
                    >
                      No outstanding balances were found for the selected DOS
                      range.
                    </td>
                  </tr>
                )}
              ...
              {rows.length > 0 && (
                <tfoot className="border-t border-blue-100 bg-[#EAF5FF] text-slate-900 dark:border-border dark:bg-muted dark:text-foreground">
                  <tr>
                    ...
                    <td className="whitespace-nowrap px-5 py-4 text-right font-semibold text-[#2563EB] dark:text-foreground">
                      {formatCurrency(summary.total_paid)}
                    </td>
