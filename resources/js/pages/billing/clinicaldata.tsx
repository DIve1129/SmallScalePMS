...
export default function ClinicalDataCreate({ appointment }: { appointment: AppointmentInfo }) {
    ...
    const labelClass = 'mb-1.5 block text-xs font-medium uppercase tracking-wider text-slate-500 dark:text-muted-foreground';
        ...
        >
            ...
            <div className="mx-auto max-w-5xl space-y-6 bg-[#F8FAFC] p-6 text-slate-800 dark:bg-background dark:text-foreground">
                ...
                <div className="flex items-center justify-between border-b border-blue-100 pb-4 dark:border-border">
                    <div>
                        <h1 className="text-2xl font-semibold text-slate-900 dark:text-foreground">Add Clinical Encounter Data</h1>

                        <p className="text-sm text-slate-500 dark:text-muted-foreground">
                            Log physical observations, patient vitals, and final medical chart assessments
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 gap-4 rounded-xl border border-blue-100 bg-[#EAF5FF] p-4 text-sm shadow-sm md:grid-cols-4 dark:border-border dark:bg-muted">
                    ...
                    <div>
                        ...
                        <span className="font-semibold text-slate-900 dark:text-foreground">{appointment.doctor_name}</span>
                    </div>

                    <div>
                        <span className="block text-xs font-medium text-slate-500 dark:text-muted-foreground">Encounter Context</span>

                        <span className="font-semibold text-slate-900 dark:text-foreground">{appointment.appointment_reason}</span>
                    </div>

                    <div>
                        <span className="block text-xs font-medium text-slate-500 dark:text-muted-foreground">Date of Encounter</span>

                        <span className="font-semibold text-slate-900 dark:text-foreground">{appointment.appointment_date}</span>
                    </div>
                </div>
