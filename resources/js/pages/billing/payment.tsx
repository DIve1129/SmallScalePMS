    ...
    return (
        ...
        >
            ...
            <div className="space-y-6 bg-[#F8FAFC] p-6 dark:bg-background">
                {/* Page heading */}
                <div>
                    <h1 className="text-2xl font-semibold text-slate-900 dark:text-foreground">Post Payment</h1>

                    <p className="text-sm text-slate-500 dark:text-muted-foreground">Post payments per service.</p>
                </div>
